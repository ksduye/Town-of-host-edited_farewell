...
[BepInPlugin(PluginGuid, "TOHEF", PluginVersion)]
[BepInIncompatibility("jp.ykundesu.supernewroles")]
[BepInProcess("Among Us.exe")]
public class Main : BasePlugin
{
    // == プログラム設定 / Program Config ==
    public static readonly string ModName = "TOHEF";
    public static readonly string ModColor = "#00BFFF";
    public static readonly bool AllowPublicRoom = true;
    public static readonly string ForkId = "TOHEF";
    ...
    public const string PluginGuid = "com.ksduye.Town-of-host-edited_farewell";
    public const string PluginVersion = "1.2.6";
    public const string PluginDisplayVersion = "1.2.6";
    public const int PluginCreate = 5;

    public static readonly bool ShowQQButton = true;
    public static readonly string QQInviteUrl = "";
    ...
    internal static bool hasAccess;
    ...
    public static object UnlockFPS { get; internal set; }
    ...
    public override void Load()
    {
        ...
        //Client Options
        HideName = Config.Bind("Client Options", "Hide Game Code Name", "TOHEF");
        ...
        Logger = BepInEx.Logging.Logger.CreateLogSource("TOHEF");
        TOHE.Logger.Enable();
